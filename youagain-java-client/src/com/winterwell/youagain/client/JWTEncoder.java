...
public class JWTEncoder {
	...
	/**
	 * @deprecated Best to use the full args version
	...
	public String encryptJWT(XId xid) throws Exception {
		return encryptJWT(xid, null, null);
	}
	 ...
	 * @throws Exception
	 */
	public String encryptJWT(XId xid, CharSequence dataspace, Map<String,Object> extraProperties) throws Exception {
...
//	    claims.setExpirationTimeMinutesInTheFuture(10); // time when the token will expire (10 minutes from now)
	    ...
	    if (dataspace!=null) {
	    	jwtb.withAudience(dataspace.toString()); // NB: audience is String[]
	    }
