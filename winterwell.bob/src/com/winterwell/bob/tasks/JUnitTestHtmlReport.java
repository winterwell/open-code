 ...
 */
final class JUnitTestHtmlReport implements TestListener {
	...
	private static TestSuite build(File directory) throws IOException {
		...
		List<String> classNames = JUnitTestHtmlReport.getAllClasses(directory);
	...
	private static List<String> getAllClasses(File root) throws IOException {
		...
		JUnitTestHtmlReport.getAllClasses(root, path.length() + 1, classNames);
	 ...
	 */
	public JUnitTestHtmlReport(File sourceDirectory, File classDirectory) {
	...
	public void endTest(Test test) {
		...
		out.println(" <td valign=\"top\"><font face=\"courier\"> "
				+ JUnitTestHtmlReport.getTime(time) + "</font></td>");
	...
	public void print() throws IOException {
		...
		TestSuite suite = JUnitTestHtmlReport.build(classDirectory_);
	...
	private void printFooter() {
		...
		out.println(" <td><font size=+0 face=\"courier\">"
				+ JUnitTestHtmlReport.getTime(System.currentTimeMillis() - time0_)
				+ "</td>");
		out.println(" </tr>");
