...
public class Bob {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// HACK poke server-type so BuildHacks can find it
			if (_settings.serverType != null) {
				Properties props = Dep.setIfAbsent(Properties.class, new Properties());
				props.put("serverType", _settings.serverType);
			}
			...
			// filter out jvm args? No they should be gone already
