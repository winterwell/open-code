...
public class ShareServlet implements IServlet {
	...
	// Protect against open redirections
	Pattern redirectUrlPattern = Pattern.compile("^https?://([a-zA-Z0-9.-]*\\.)?(good-loop\\.com|sogive\\.org)(/[a-zA-Z0-9_\\-.~%:/?#\\[\\]@!$&\\(\\)*\\+,;=]*)?$", Pattern.CASE_INSENSITIVE);
	...
	public void process(WebRequest state) throws Exception {
		...
		page.setTitle(WebUtils.htmlEncode(title));		
